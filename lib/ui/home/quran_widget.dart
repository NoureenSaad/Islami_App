    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            Text(AppLocalizations.of(context)!.chaptername,style: Theme.of(context).textTheme.titleLarge),
            Text(AppLocalizations.of(context)!.chapternumber,style: Theme.of(context).textTheme.titleLarge),
          ],
        ),
        Divider(
          height: 2,
